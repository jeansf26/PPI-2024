...
<div class="container " style="margin-left: 210px !important; font-size: 1.3rem; width: 80%;">
        <form action="cadastro_prof.php" method="post">
            <div class="mb-3">
                ...
                <input class="form-control py-1" type="text" id="name" name="name" placeholder="Digite o nome">
            </div>
            <div class="mb-3">
                <label class="form-label" for="mal">Email:</label>
                <input class="form-control py-1" type="text" id="mal" name="mal" placeholder="Digite o email">
            </div>
            <div class="mb-3">
                <label class="form-label" for="psw">Senha:</label>
                <input class="form-control py-1" type="password" id="psw" name="psw" placeholder="Digite a senha">
            </div>
            <div class="mb-3">
                <label class="form-label" for="mat">Matricula SIAPE:</label>
                <input class="form-control py-1" type="text" id="mat" name="mat" placeholder="Digite a matrícula">
            </div>
