...
//faz o INSERT na tabela "usuario" no BANCO "progweb" 
		...
		$senha_encriptada = md5($sen);
			...
			$sql = "INSERT INTO usuario_setor_professor_administrador (Nome,Email,Senha,Tipo_usuario,MatriculaSiape) VALUES('{$nom}','{$ema}','{$senha_encriptada}','{$tipo}','{$mat}')" or die( mysql_error() );
